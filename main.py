...
def parse_args():
    ...
    parser.add_argument('--input', nargs='?', default='D:/工作实习/Hikvision/三篇论文整理/GraphEmbeddings/graph/cora/progressed/cora_edges.txt',
                        help='Input graph path')
    parser.add_argument('--input_label', nargs='?', default='D:/工作实习/Hikvision/三篇论文整理/GraphEmbeddings/graph/cora/progressed/cora_labels.txt',
                        help='Input graph path')
    parser.add_argument('--output', nargs='?', default='out_embedding/cora.emb',
...
def main(args):
    ...
    plot_embeddings(embeddings=embeddings, label_file=args.input_label)
